...
class SeparateSequencesWithCountDataset(Dataset):
    def __init__(self, df: pd.DataFrame, seq_tokenizer: SeparateSequenceTokenizer, seq_df_key: str = "pitch_sequence", count_seq_df_key: str = "count_sequence") -> None:
        super().__init__()
        self.df = df
        self.seq_tokenizer = seq_tokenizer
        self.seq_df_key = seq_df_key
    ...
    def __getitem__(self, idx):
        ...
        return input_seq, count_seq, padding_mask, target
